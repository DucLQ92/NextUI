...
static const char *builtin_vi[][2] = {
    ...
    {"Sync LED color with the active palette's main color. Also updates LedControl settings.", "Đồng bộ màu LED theo màu chính (Main Color) của bảng màu đang dùng. Cũng cập nhật cài đặt LedControl."},
